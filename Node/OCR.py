...
def process_ocr_page(state: PageState):
    ...
    prompt_text = (
        "คุณคือผู้เชี่ยวชาญการทำ OCR และวิเคราะห์โจทย์ข้อสอบฟิสิกส์ที่อิงตามหลักสูตรแกนกลางของกระทรวงศึกษาธิการไทย   "
        ...
        '   "Exam_objecttive": "ผลลัพธ์การวิเคราะห์แล้ว classify ข้อผิดพลาดของนักเรียนในแต่ละข้อ"\n'
        '   "class_": "class ที่เป็นไปได้สำหรับการ classify ที่เป็นตัวเลข match กับ Exam_objecttive เพื่อนำไปนำไปวิเคราะห์ accuracy ของการ classify "\n'
        "  },{...}\n"
        "]\n"
    ...
    sys_prompt = SystemMessage(content =[{'type': 'text', 'text': prompt_text },
                                         {'type': 'text', 'text': f"นี่คือ class label ที่ใช้ในการ classify Exam_objecttive ในแต่ละข้อ: {state['labels']}"}])
